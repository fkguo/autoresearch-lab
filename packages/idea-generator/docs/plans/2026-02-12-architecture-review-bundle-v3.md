# Review Bundle (v3): idea-generator architecture spec + schemas + RPC

Please review the bundle below. Focus on:
- Are contracts now machine-enforceable? (JSON Schema + OpenRPC; OpenRPC is now self-contained)
- Is the Multi-Island state machine observable/enforceable? (island_states + enums + RPC result shapes)
- Does the new Physicist Community (Team/Role) model stay modular and avoid coupling core↔orchestrator?
- Novelty: does the Referee/novelty_delta_table requirement prevent "细枝末节当成创新"?
...
- **最小方法集（v1）**：
  ...
  - `search.step`
  - `idea.get` / `idea.list` / `idea.promote`
  - `eval.run`
  - `rank.compute`
- **错误码约定**：至少包含 `budget_exhausted` / `schema_validation_failed` / `grounding_audit_failed` / `formalism_not_in_registry` / `campaign_not_found` / `idea_not_found`
...
1. **URI 可解析**：`claims[].evidence_uris[]` 必须可解析（INSPIRE/DOI/KB artifact），不存在 phantom 引用。
...
审计输出写入 `IdeaNode.grounding_audit`（并可汇总进 `idea_evidence_graph_v1.json`）。
...
Referee 在输出 novelty 结论时必须包含一个 `novelty_delta_table`（可作为 `eval_info` 的结构化字段或独立 artifact），至少回答：
...
- `candidate_formalisms[]` 必须来自该 registry；否则 `idea.promote` 必须失败（schema_validation_failed 或 grounding_audit_failed）。
...
--- BEGIN: schemas/rationale_draft_v1.schema.json ---
{
  ...
  "$id": "https://idea-generator/schemas/rationale_draft_v1.schema.json",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/idea_card_v1.schema.json",
  "title": "IdeaCard v1",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/idea_node_v1.schema.json",
  "title": "IdeaNode v1",
  ...
  "properties": {
    ...
    "grounding_audit": {
      ...
      "allOf": [
        {
          "if": { "type": "object" },
          "then": { "required": ["status", "failures", "timestamp"] }
        }
      ],
      "additionalProperties": false
    },
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/campaign_charter_v1.schema.json",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/seed_pack_v1.schema.json",
  "title": "SeedPack v1",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/budget_envelope_v1.schema.json",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/budget_snapshot_v1.schema.json",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/island_state_v1.schema.json",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/search_step_result_v1.schema.json",
  ...
  "type": "object",
  "required": ["campaign_id", "n_steps_executed", "new_node_ids", "island_states", "budget_snapshot"],
  "properties": {
    "campaign_id": { "type": "string", "minLength": 1 },
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/campaign_status_v1.schema.json",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/idea_list_filter_v1.schema.json",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/evaluator_config_v1.schema.json",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/eval_result_v1.schema.json",
  "title": "EvalResult v1",
  "description": "Result of eval.run. Engine persists eval_info into IdeaNodes and returns artifact refs + budget snapshot.",
  "type": "object",
  "required": ["idea_ids", "scorecards_artifact_ref", "budget_snapshot"],
  "properties": {
    "idea_ids": { "type": "array", "minItems": 1, "items": { "type": "string", "format": "uuid" } },
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/ranking_result_v1.schema.json",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://idea-generator/schemas/promotion_result_v1.schema.json",
  ...
  "type": "object",
  "required": ["idea_id", "handoff_artifact_ref", "formalism_check", "grounding_audit_summary"],
  "properties": {
    "idea_id": { "type": "string", "format": "uuid" },
...
--- BEGIN: schemas/idea_core_rpc_v1.openrpc.json ---
{
  ...
  "info": {
    ...
    "version": "1.1.0",
    "description": "JSON-RPC interface between the idea-generator adapter (hepar skill) and the standalone idea-core engine. This OpenRPC doc is self-contained (no external $ref) for portability."
  },
  "methods": [
    {
      "name": "campaign.init",
      ...
      "params": [
        { "name": "charter", "schema": { "$ref": "#/components/schemas/CampaignCharterV1" } },
        { "name": "seed_pack", "schema": { "$ref": "#/components/schemas/SeedPackV1" } },
        { "name": "budget", "schema": { "$ref": "#/components/schemas/BudgetEnvelopeV1" } },
        { "name": "idempotency_key", "schema": { "type": "string", "minLength": 1 }, "required": false }
      ],
    ...
    },
    {
      ...
      "params": [{ "name": "campaign_id", "schema": { "type": "string", "minLength": 1 } }],
    ...
    },
    {
      ...
      "params": [
        { "name": "campaign_id", "schema": { "type": "string", "minLength": 1 } },
        { "name": "n_steps", "schema": { "type": "integer", "minimum": 1 }, "required": false },
        { "name": "idempotency_key", "schema": { "type": "string", "minLength": 1 }, "required": false }
      ],
    ...
    {
      "name": "idea.get",
      "summary": "Fetch a single IdeaNode.",
    ...
    {
      "name": "idea.list",
      "summary": "List IdeaNodes in a campaign.",
      "params": [
        { "name": "campaign_id", "schema": { "type": "string", "minLength": 1 } },
        { "name": "filter", "schema": { "$ref": "#/components/schemas/IdeaListFilterV1" }, "required": false },
        { "name": "limit", "schema": { "type": "integer", "minimum": 1 }, "required": false }
      ],
      "result": { "name": "idea_list", "schema": { "$ref": "#/components/schemas/IdeaListResultV1" } },
      "errors": [{ "code": -32003, "message": "campaign_not_found" }]
    },
    {
      "name": "idea.promote",
      "summary": "Promote an idea to a C2 handoff artifact (after schema + grounding + formalism gates).",
      "params": [{ "name": "idea_id", "schema": { "type": "string", "format": "uuid" } }],
      "result": { "name": "promotion_result", "schema": { "$ref": "#/components/schemas/PromotionResultV1" } },
      "errors": [
        { "code": -32004, "message": "idea_not_found" },
        { "code": -32002, "message": "schema_validation_failed" },
    ...
    {
      "name": "eval.run",
      "summary": "Run evaluation (multi-agent scoring) on a set of ideas and persist eval_info.",
      "params": [
        {
          "name": "idea_ids",
          "schema": { "type": "array", "minItems": 1, "items": { "type": "string", "format": "uuid" } }
        },
        { "name": "evaluator_config", "schema": { "$ref": "#/components/schemas/EvaluatorConfigV1" } }
      ],
      "result": { "name": "eval_result", "schema": { "$ref": "#/components/schemas/EvalResultV1" } },
      "errors": [{ "code": -32001, "message": "budget_exhausted" }]
    },
    {
      "name": "rank.compute",
      ...
      "params": [
        { "name": "campaign_id", "schema": { "type": "string", "minLength": 1 } },
        { "name": "method", "schema": { "enum": ["pareto", "elo"] } }
      ],
    ...
    "schemas": {
      ...
      "CampaignCharterV1": {
        ...
        "properties": {
          ...
          "scope": { "type": "string", "minLength": 10 },
          "approval_gate_ref": { "type": "string", "minLength": 1 },
          "objectives": { "type": "array", "items": { "type": "string", "minLength": 1 } },
          "constraints": { "type": "array", "items": { "type": "string", "minLength": 1 } },
          "search_policy_id": { "type": "string", "minLength": 1 },
          "team_policy_id": { "type": "string", "minLength": 1 },
      ...
      "CampaignStatusV1": {
        ...
        "properties": {
          ...
          "status": { "enum": ["running", "early_stopped", "exhausted", "completed"] },
          "created_at": { "type": "string", "format": "date-time" },
          "budget_snapshot": { "$ref": "#/components/schemas/BudgetSnapshotV1" },
          "island_states": {
            "type": "array",
            "minItems": 1,
            "items": { "$ref": "#/components/schemas/IslandStateV1" }
          },
          "node_count": { "type": "integer", "minimum": 0 },
          "last_step_id": { "type": "string", "format": "uuid" }
        },
      ...
      "IdeaNodeV1": {
        ...
        "properties": {
          ...
          "island_id": { "type": "string", "minLength": 1 },
          "operator_id": { "type": "string", "minLength": 1 },
          "rationale_draft": { "$ref": "#/components/schemas/RationaleDraftV1" },
          "idea_card": { "oneOf": [{ "$ref": "#/components/schemas/IdeaCardV1" }, { "type": "null" }] },
          "origin": {
            "type": "object",
            "required": ["model", "temperature", "prompt_hash", "timestamp"],
            "properties": {
          ...
          "eval_info": {
            ...
            "allOf": [{ "if": { "type": "object" }, "then": { "required": ["fix_suggestions", "failure_modes"] } }],
            "additionalProperties": false
          },
          "grounding_audit": {
            "type": ["object", "null"],
            ...
            "allOf": [{ "if": { "type": "object" }, "then": { "required": ["status", "failures", "timestamp"] } }],
            "additionalProperties": false
          },
          "created_at": { "type": "string", "format": "date-time" }
        },
