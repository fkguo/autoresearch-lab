# Review Bundle (v26): idea-generator architecture spec + schemas + RPC
...

{
  ...
  "properties": {
    ...
    "transition": {
      "type": "object",
      "description": "Machine-readable status transition summary for this mutation call (useful for automated adapters).",
