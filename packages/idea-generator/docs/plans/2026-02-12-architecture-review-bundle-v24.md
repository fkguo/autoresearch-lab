# Review Bundle (v24): idea-generator architecture spec + schemas + RPC
...

{
  ...
  "methods": [
    ...
    },
    {
      ...
      "description": "Side-effecting. Only permitted when campaign status is running; otherwise campaign_not_active. Batch size is capped (node_ids maxItems=100) to bound rollback cost. Atomicity (MUST): on any error (including budget_exhausted, node_not_found, node_not_in_campaign), the engine MUST perform no partial writes/mutations; if partial work occurs internally it MUST be rolled back before returning (and before storing the idempotency record).",
...

{
  ...
  "properties": {
    ...
    "selected_node_ids": { "type": "array", "minItems": 1, "items": { "type": "string", "format": "uuid" } },
        ...
        "oneOf": [
          {
            ...
            "properties": {
              "claim_text": { "type": "string", "minLength": 1 },
              "support_type": { "enum": ["literature", "data", "calculation", "expert_consensus"] },
              "evidence_uris": { "type": "array", "minItems": 1, "items": { "type": "string", "format": "uri" } },
              "confidence": { "type": "number", "minimum": 0, "maximum": 1 },
          ...
          {
            "title": "Inference/assumption-backed claim",
            "type": "object",
            "required": ["claim_text", "support_type", "evidence_uris", "verification_plan"],
            "properties": {
              "claim_text": { "type": "string", "minLength": 1 },
              "support_type": { "enum": ["llm_inference", "assumption"] },
              "evidence_uris": { "type": "array", "items": { "type": "string", "format": "uri" } },
              "confidence": { "type": "number", "minimum": 0, "maximum": 1 },
