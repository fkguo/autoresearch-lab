# Review Bundle (v34): reduction_audit + distributor factorization contracts
Please review the bundle below. Focus on:
- Cross-disciplinary: `ProblemReduction` workflow is now contract-backed (`reduction_report` + `reduction_audit` gate)
- Distributor: factorization is campaign-declared + auditable artifacts + BanditPolicy minimal interface
- Contract machine-enforceability: schemas/OpenRPC reflect the gates and error codes (no prose-only invariants)
...
- `schemas/reduction_report_v1.schema.json`
- `schemas/reduction_audit_v1.schema.json`
- `schemas/novelty_delta_table_v1.schema.json`
- `schemas/distributor_policy_config_v1.schema.json`
- `schemas/distributor_event_v1.schema.json`
- `schemas/distributor_state_snapshot_v1.schema.json`
...
6. **归约审计（reduction_audit，条件性强约束）**：当 `IdeaNode.reduction_report != null`（通常来自 `ProblemReduction`/`TechniqueTransplant`）时，`node.promote` 的成功条件**额外**要求 `reduction_audit.status == pass`。`partial/fail` 一律阻塞晋升（返回 `reduction_audit_failed`）。审计最小检查项：
  ...
  "properties": {
    ...
    "reduction_map": {
      ...
      "items": {
        ...
        "properties": {
          "source": { "type": "string", "minLength": 1, "description": "Target-domain element." },
          "target": { "type": "string", "minLength": 1, "description": "Abstract-domain element." },
          "mapping": { "type": "string", "minLength": 1, "description": "Explanation of the correspondence." },
          "invariant": { "type": "string", "description": "Optional invariant that must hold under the mapping." },
          "notes": { "type": "string" }
        },
        "additionalProperties": false
      }
    ...
    "assumptions_and_limits": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "verification_status": { "enum": ["pending", "satisfied", "violated"], "default": "pending" },
    ...
    "known_solutions": {
      ...
      "items": {
        "type": "object",
        "required": ["name", "prerequisites", "failure_modes", "reference_uris"],
        "properties": {
          ...
          "reference_uris": { "type": "array", "minItems": 1, "items": { "type": "string", "format": "uri" } },
    ...
    "transfer_plan": {
      ...
      "items": {
        "type": "object",
        "required": ["step", "expected_output", "acceptance"],
        "properties": {
    ...
    "minimal_toy_check": {
      "type": "object",
      "required": ["setup", "expected_result", "pass_fail_criteria"],
      "properties": {
        "setup": { "type": "string", "minLength": 1 },
        "expected_result": { "type": "string", "minLength": 1 },
        "pass_fail_criteria": { "type": "string", "minLength": 1 },
        "code_sketch_ref": { "type": "string", "format": "uri" },
        "data_ref": { "type": "string", "format": "uri" }
      },
      "additionalProperties": false
    },
    "kill_criteria": { "type": "array", "minItems": 1, "items": { "type": "string", "minLength": 1 } },
    "reference_uris": { "type": "array", "items": { "type": "string", "format": "uri" } },
    "extensions": {
      "type": "object",
...

{
  ...
  "type": "object",
  "required": ["status", "assumptions", "toy_check_result", "reduction_type_valid", "failures", "timestamp"],
  "properties": {
    ...
    "assumptions": {
      ...
      "items": {
        "type": "object",
        "required": ["assumption_id", "status"],
        "properties": {
          "assumption_id": { "type": "string", "minLength": 1 },
          "status": { "enum": ["satisfied", "pending_verification", "violated"] },
          "notes": { "type": "string" },
          "evidence_uris": { "type": "array", "items": { "type": "string", "format": "uri" } }
        },
        "additionalProperties": false
    ...
    "toy_check_result": { "enum": ["pass", "fail", "skipped"] },
  ...
  "allOf": [
    {
      "if": { "properties": { "toy_check_result": { "const": "skipped" } }, "required": ["toy_check_result"] },
      "then": { "required": ["skip_reason"], "properties": { "skip_reason": { "minLength": 1 } } }
    }
  ],
  "additionalProperties": false
}
...

{
  ...
  "type": "object",
  "required": ["campaign_id", "policy_id", "policy_family", "action_space", "created_at"],
  "properties": {
    ...
    "action_space": {
      ...
      "properties": {
        ...
        "backend_ids": { "type": "array", "items": { "type": "string", "minLength": 1 } },
        "operator_ids": { "type": "array", "items": { "type": "string", "minLength": 1 } },
        "island_ids": { "type": "array", "items": { "type": "string", "minLength": 1 } },
        "team_policy_ids": { "type": "array", "items": { "type": "string", "minLength": 1 } }
      },
      "additionalProperties": false
    },
    "reward_mapping": {
      ...
      "properties": {
        ...
        "gate_fail_penalty": { "type": "number" },
        "reward_range": { "type": "array", "minItems": 2, "maxItems": 2, "items": { "type": "number" } }
      },
      "additionalProperties": false
    },
    "cost_mapping": {
      ...
      "properties": {
        "lambda_cost": { "type": "number", "minimum": 0 },
        "cost_unit": { "type": "string", "minLength": 1 }
      },
      "additionalProperties": false
    },
    "hyperparameters": {
    ...
    "deterministic_sampling": {
      ...
      "properties": {
        "rng_alg": { "type": "string", "minLength": 1 },
        "seed_strategy": { "type": "string", "minLength": 1 }
      },
      "additionalProperties": false
    },
