# Review Bundle (v40): apply v39 review micro-patches (safety + audit + usability)
Please review the bundle below. Focus on:
- `ranking_result_v1.effective_dimensions` now enforces `uniqueItems: true`
- `idea_list_filter_v1` adds `has_reduction_report` for queuing reduction audits
- `rpc_error_data_v1` now requires `idempotency_key` + `payload_hash` when `reason=idempotency_key_conflict`
- `reduction_audit_v1` adds optional `auditor_origin` for clean-room provenance
- `distributor_event_v1`: if `rng_seed_used` is present, `rng_alg` is required (self-contained replay)
- OpenRPC bumps to v1.9.7 and clarifies idempotency conflict error payload_hash
...
--- BEGIN: schemas/abstract_problem_registry_v1.schema.json ---
...
--- END: schemas/abstract_problem_registry_v1.schema.json ---
...

{
  ...
  "properties": {
    ...
    "distributor": {
      "type": "object",
      "description": "Distributor/BanditPolicy campaign-level configuration (auditable; must remain stable within a campaign).",
      "properties": {
        "policy_id": {
          "type": "string",
          "minLength": 1
    ...
    "extensions": {
      "type": "object",
      "description": "DomainPack-specific knobs (kept out of the stable surface). Recommended keys: folklore_risk_threshold (number in [0,1], default 0.7; if folklore_risk_score >= threshold then require A0-folklore human gate).",
      "additionalProperties": true
    }
  },
  "additionalProperties": false
...

{
  ...
  "properties": {
    ...
    "island_states": {
      ...
      "minItems": 1,
      "items": {
        "$ref": "./island_state_v1.schema.json"
      }
    },
    "distributor_policy_config_ref": {
      "type": "string",
      "format": "uri",
      "description": "Artifact ref to the immutable distributor_policy_config_v1.json for this campaign (if Distributor is enabled)."
    },
    "idempotency": {
...
--- BEGIN: schemas/distributor_event_v1.schema.json ---
...
--- END: schemas/distributor_event_v1.schema.json ---


--- BEGIN: schemas/distributor_policy_config_v1.schema.json ---

{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "distributor_policy_config_v1.schema.json",
  "title": "DistributorPolicyConfig v1",
  "description": "Immutable per-campaign Distributor/BanditPolicy configuration for audit + replay.",
  "type": "object",
  "required": [
    "campaign_id",
    "policy_id",
  ...
  "properties": {
    ...
    "policy_family": {
      "type": "string",
      "minLength": 1,
      "description": "Policy family identifier (e.g., softmax_ema, annealed_gibbs_entropy_floor, replicator_mw_kl, ucb_v, thompson, exp3)."
    },
    "action_space": {
      "type": "object",
      "required": [
    ...
    "reward_mapping": {
      "type": "object",
      "description": "Mapping from multi-objective scorecards to a scalar reward (must be logged for audit).",
      "properties": {
        "score_weights": {
          "type": "object",
    ...
    "cost_mapping": {
      "type": "object",
      "description": "Cost mapping and/or Lagrangian penalty configuration.",
      "properties": {
        "lambda_cost": {
          "type": "number",
          "minimum": 0
    ...
    "hyperparameters": {
      "type": "object",
      "description": "Policy-family specific hyperparameters (e.g., temperature schedule, epsilon floor, eta schedule, p_min).",
      "additionalProperties": true
    },
    "deterministic_sampling": {
      "type": "object",
      "description": "Determinism controls for replay (required when runtime sampling is used).",
      "properties": {
        "rng_alg": {
          "type": "string",
          "minLength": 1
...
--- END: schemas/distributor_policy_config_v1.schema.json ---


--- BEGIN: schemas/distributor_state_snapshot_v1.schema.json ---

{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "distributor_state_snapshot_v1.schema.json",
  "title": "DistributorStateSnapshot v1",
  "description": "Optional periodic snapshot of Distributor/BanditPolicy internal state for debugging + replay tooling.",
  "type": "object",
  "required": ["campaign_id", "policy_id", "timestamp", "action_stats"],
  "properties": {
    "campaign_id": { "type": "string", "format": "uuid" },
    "policy_id": { "type": "string", "minLength": 1 },
    "timestamp": { "type": "string", "format": "date-time" },
    "action_stats": {
      "type": "object",
      "description": "Map action_id → stats used by the policy (n, Q, C, variance, weights, etc.).",
      "additionalProperties": {
        "type": "object",
        "properties": {
    ...
    "current_probs": {
      "type": "object",
      "description": "Map action_id → current selection probability.",
      "additionalProperties": { "type": "number", "minimum": 0, "maximum": 1 }
    },
    "temperature": { "type": "number", "minimum": 0 },
    "epsilon_floor": { "type": "number", "minimum": 0, "maximum": 1 }
  },
  "additionalProperties": false
}

--- END: schemas/distributor_state_snapshot_v1.schema.json ---
...
--- BEGIN: schemas/failed_approach_v1.schema.json ---

{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "failed_approach_v1.schema.json",
  "title": "FailedApproach v1",
  "description": "One structured negative-result record (one line in failed_approach_v1.jsonl).",
  "type": "object",
  "required": ["approach_summary", "failure_mode", "failure_evidence_uris", "lessons", "reuse_potential"],
  "properties": {
    "approach_id": { "type": "string", "format": "uuid" },
    "campaign_id": { "type": "string", "format": "uuid" },
    "idea_id": { "type": "string", "format": "uuid" },
    "approach_summary": { "type": "string", "minLength": 1 },
    "failure_mode": { "type": "string", "minLength": 1 },
    "failure_evidence_uris": { "type": "array", "items": { "type": "string", "format": "uri" } },
    "lessons": { "type": "array", "minItems": 1, "items": { "type": "string", "minLength": 1 } },
    "reuse_potential": { "enum": ["low", "medium", "high"] },
...
--- END: schemas/failed_approach_v1.schema.json ---
...

{
  ...
  "properties": {
    ...
    "distributor_policy_config_ref": {
      "type": "string",
      "format": "uri",
      "description": "Artifact reference (URI) to distributor_policy_config_v1.json for this campaign (if enabled)."
    },
    "node_count": {
      "type": "integer",
      "minimum": 0
...

{
  ...
  "properties": {
    ...
    "has_eval_info": { "type": "boolean", "description": "Filter on presence of eval_info (true=eval_info!=null; false=eval_info==null)." },
    "has_reduction_report": { "type": "boolean", "description": "Filter on presence of reduction_report (true=non-null; false=null)." },
...

{
  ...
  "title": "IdeaNode v1",
  "description": "A single candidate node in the ideation search space, with lineage, traces, diagnostics, and optional formalized IdeaCard.\n\nMutability contract (audit-first): Fields campaign_id, idea_id, node_id, parent_node_ids, island_id, operator_id, operator_family, origin, operator_trace, rationale_draft, created_at are IMMUTABLE after creation. Fields revision, idea_card, eval_info, grounding_audit, reduction_report, reduction_audit, updated_at are MUTABLE (append/replace semantics; prior values should be preserved in the ledger or history artifacts). revision is engine-managed: initialized to 1 at creation and incremented on each mutation.",
  "type": "object",
  "required": [
    "campaign_id",
    "idea_id",
  ...
  "properties": {
    ...
    "operator_family": {
      "type": "string",
      "minLength": 1,
      "description": "Operator family (stable tag for audits/gates; recommended but not strictly required in v0.2)."
    },
    "rationale_draft": {
...
--- BEGIN: schemas/novelty_delta_table_v1.schema.json ---

{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "novelty_delta_table_v1.schema.json",
  "title": "NoveltyDeltaTable v1",
  "description": "Structured novelty deltas to avoid mistaking superficial changes for innovation (Referee hard constraint).",
  "type": "array",
  "minItems": 1,
  "items": {
    "type": "object",
...
--- END: schemas/novelty_delta_table_v1.schema.json ---
...
--- BEGIN: schemas/reduction_audit_v1.schema.json ---
...
--- END: schemas/reduction_audit_v1.schema.json ---


--- BEGIN: schemas/reduction_report_v1.schema.json ---

{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "reduction_report_v1.schema.json",
  "title": "ReductionReport v1",
  "description": "Structured report produced by ProblemReduction/TechniqueTransplant operators: abstract problem mapping, assumptions/limits, known solutions, transfer plan, and minimal toy check.",
  "type": "object",
  "required": [
    "abstract_problem",
    "reduction_map",
  ...
  "properties": {
    "abstract_problem": {
      "type": "string",
      "minLength": 1,
      "description": "Abstract problem type (must be registered in the DomainPack abstract_problem_registry at runtime)."
    },
    "reduction_map": {
      "type": "array",
      "minItems": 8,
      "description": "Target-domain → abstract-domain mapping table (variables/objectives/constraints/symmetries/invariants).",
      "items": {
        "type": "object",
        "required": [
          "source",
        ...
        "properties": {
          "source": {
            "type": "string",
            "minLength": 1,
            "description": "Target-domain element."
          },
          "target": {
            "type": "string",
            "minLength": 1,
            "description": "Abstract-domain element."
          },
          "mapping": {
            "type": "string",
            "minLength": 1,
            "description": "Explanation of the correspondence."
          },
          "invariant": {
            "type": "string",
            "description": "Optional invariant that must hold under the mapping."
          },
          "notes": {
            "type": "string"
          }
    ...
    "assumptions_and_limits": {
      "type": "array",
      "minItems": 1,
      "description": "Assumptions and validity limits required for the reduction/transfer to hold.",
      "items": {
        "type": "object",
        "required": [
          "assumption_id",
    ...
    "known_solutions": {
      "type": "array",
      "minItems": 2,
      "description": "Mature solution candidates from math/CS/other domains (each must include at least one primary reference).",
      "items": {
        "type": "object",
        "required": [
          "name",
    ...
    "transfer_plan": {
      "type": "array",
      "minItems": 1,
      "description": "Minimal steps to apply the abstract-domain method back to the target domain (must be executable/auditable).",
      "items": {
        "type": "object",
        "required": [
          "step",
    ...
    "compatibility_checks": {
      "type": "array",
      "description": "Target-domain consistency checks that must pass (dimensions/symmetries/limits/reproducibility).",
      "minItems": 2,
      "items": {
        "type": "string",
        "minLength": 1
    ...
    "extensions": {
      "type": "object",
      "description": "Operator/DomainPack specific extensions.",
      "additionalProperties": true
    }
  },
  "additionalProperties": false
...
--- END: schemas/reduction_report_v1.schema.json ---
...

{
  ...
  "properties": {
    ...
    "distributor_policy_config_ref": {
      "type": "string",
      "format": "uri",
      "description": "Artifact ref to the immutable distributor_policy_config_v1.json for this campaign (required for audit/replay when Distributor is used)."
    },
    "idempotency": {
      "$ref": "./idempotency_meta_v1.schema.json"
    },
