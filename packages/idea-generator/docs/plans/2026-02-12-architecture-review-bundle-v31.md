# Review Bundle (v31): idea-generator architecture spec + schemas + RPC
...

{
  ...
  "allOf": [
    ...
    },
    {
      ...
      "then": { "properties": { "transition": { "properties": { "current_status": { "const": "running" } } } } }
    },
    {
      "if": {
      ...
      "then": { "properties": { "transition": { "properties": { "current_status": { "const": "paused" } } } } }
    },
    {
      "if": {
      ...
      "then": { "properties": { "transition": { "properties": { "current_status": { "const": "early_stopped" } } } } }
    },
    {
      "if": {
...

{
  ...
  "properties": {
    ...
    "mutations": {
      ...
      "items": {
        "type": "object",
        "required": ["node_id", "mutated_fields", "timestamp"],
        "properties": {
