# Review Bundle (v30): idea-generator architecture spec + schemas + RPC
...

{
  ...
  "description": "SSOT artifact: campaign-level snapshot for idea search (charter + status + key artifact refs).",
  "$comment": "Stub schema (v0.2): expand fields as campaign-level artifact contracts are implemented.",
  "type": "object",
  "required": ["campaign_id", "charter", "status", "created_at"],
  "properties": {
