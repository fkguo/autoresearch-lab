# Review Bundle: 2026-02-13 M1+M2(min) Implementation v6 (post-v5 blocker fixes)

## 1) Scope

Commits included:
- `352a8f4` M1 bootstrap + contract tooling
- `824b009` M2 minimal runtime
- `ae260a5` hardening fixes
- `0193371` node discovery read APIs
- `d3eadd7` portable lock + prepared/committed idempotency staging
- `007999b` stop caching error idempotency + explicit stubs for declared/unimplemented methods

## 2) v5 Blockers -> Fix Mapping

- **B1 (pre-condition errors were idempotency-cached)**:
  - Fixed by making `_store_idempotency(..., kind="error")` a no-op.
  - Only successful outcomes are persisted for replay.
- **B2 (declared methods missing handlers)**:
  - Added explicit dispatch entries for:
    - `campaign.topup`
    - `campaign.pause`
    - `campaign.resume`
    - `campaign.complete`
    - `search.step`
  - These return structured `method_not_implemented` instead of `method_not_found`.
- **B3 (prepared record crash window concerns)**:
  - `prepared -> committed` staging retained.
  - Mutation lock uses portable `filelock.FileLock` with per-campaign/global lock files.
...
.PHONY: bootstrap sync-contracts validate test ci run-server
...
validate:
	$(PYTHON) -m idea_core.contracts.validate
...
### FILE: src/idea_core/engine/reduction.py
...
class IdeaCoreService:
    ...
    def search_step(self, params: dict[str, Any]) -> dict[str, Any]:
        self._raise_not_implemented("search.step")
...
### FILE: tests/engine/test_node_read_methods.py
...
### FILE: contracts/idea-generator-snapshot/schemas/abstract_problem_registry_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/budget_envelope_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/budget_limit_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/budget_snapshot_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/budget_topup_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/campaign_charter_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/campaign_init_result_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/campaign_mutation_result_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/campaign_status_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/distributor_policy_config_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/distributor_state_snapshot_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/elo_config_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/eval_result_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/evaluator_config_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/failed_approach_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/formalism_registry_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/idea_campaign_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/idea_evidence_graph_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/idea_handoff_c2_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/idea_list_filter_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/idea_node_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/idea_novelty_report_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/idea_seed_pack_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/idea_selection_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/idea_tournament_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/idempotency_meta_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/node_list_result_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/node_mutation_log_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/novelty_delta_table_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/rationale_draft_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/search_step_result_v1.schema.json
...
### FILE: contracts/idea-generator-snapshot/schemas/seed_pack_v1.schema.json
