# research-writer — M9G-r2 Review Packet (anti-hallucination evidence gate)

## What changed since r1
- Tightened the linter’s citation detection to accept optional arguments (e.g., `\\cite[p.~4]{Key}`).
- Made brace parsing ignore escaped braces (`\\{`, `\\}`) to reduce false failures on complex LaTeX.
- Clarified TODO format + added good/bad examples in the guardrails prompt.
