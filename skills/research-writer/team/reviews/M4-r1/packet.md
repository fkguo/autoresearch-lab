# research-writer — M4-r1 Review Packet (apply N=10 discussion-logic patterns)

## Milestone goal
Apply recurring, journal-agnostic physics discussion logic patterns observed in an N=10 exemplar corpus into the skill playbook, while keeping the pipeline auditable and avoiding any automatic (LLM-driven) mutation of the playbook.

## Acceptance criteria
- `assets/style/physics_discussion_logic_playbook.md` includes additional reusable patterns + templates derived from exemplar papers (argument flow, diagnostics, uncertainty narration).
- `assets/style/style_sources_used.md` records the N=10 arXiv IDs used (audit trail only; no corpus dump).
- The N=10 mixed-mode workflow remains: scripts do deterministic fetch/packs + optional dual-model maps; humans/agents merge patterns into the playbook.
...
- project root: /private/var/folders/8q/y82gg9g93mxff1x7gx7w4pl40000gn/T/tmp.R87CRbhbkb/project
- tag: M2-smoke
- out: /private/var/folders/8q/y82gg9g93mxff1x7gx7w4pl40000gn/T/tmp.R87CRbhbkb/paper
