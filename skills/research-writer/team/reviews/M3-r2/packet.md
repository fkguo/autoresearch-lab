# research-writer — M3-r2 Review Packet (discussion-logic pipeline, minor hardening)

## Milestone goal
Same as M3-r1, plus minor hardening: correct LaTeX comment stripping (backslash parity) and document `--run-models` prerequisites.

## Acceptance criteria
- Same as M3-r1.
- `_strip_latex_comments` handles `\%` correctly (linebreak then comment) and does not leak comments into packs.
- Docs mention prerequisites for `--run-models`.
...
- project root: /private/var/folders/8q/y82gg9g93mxff1x7gx7w4pl40000gn/T/tmp.0QRBach67k/project
- tag: M2-smoke
- out: /private/var/folders/8q/y82gg9g93mxff1x7gx7w4pl40000gn/T/tmp.0QRBach67k/paper
