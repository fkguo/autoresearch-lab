...
3. `prompt-2026-03-09-batch3-runtime-root-dehep.md`
...
- `Batch 2` 再处理 `idea-core` 的 HEP compute/domain 假设；这是 TS idea-engine 迁移前的语义净化。
- `Batch 3` 最后处理 runtime/provider/root 的命名与入口去 HEP 占位；它重要，但对 Stage 3 的直接阻塞度低于前两批。
