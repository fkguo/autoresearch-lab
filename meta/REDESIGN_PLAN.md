...
> - 下一批 closure 也已先落成 checked-in planning material：`meta/docs/plans/2026-04-07-next-batch-generic-closure-plan.md` 给出 generic-first 三 lane 视图；`meta/docs/plans/2026-04-07-next-batch-generic-command-taxonomy-and-projection-guard.md` 细化 command taxonomy / projection-only guard 顺序；`meta/docs/prompts/prompt-2026-04-07-next-batch-front-door-command-inventory-anti-drift.md` 锁定首条 command-inventory anti-drift 实现 lane；`meta/docs/plans/2026-04-07-next-batch-residual-support-surface-closure.md` 与 `meta/docs/prompts/prompt-2026-04-07-next-batch-projection-only-support-surface-guard.md` 则把 residual support surfaces 的 projection-only / compatibility-only guard 单独落成第二条 lane
>
> **v1.9.33 Changelog**:
